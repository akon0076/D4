...
public class OperatorAndRoleController {
    ...
    @GetMapping("/findOperatorAndRoleByOperatorIdAndOrganizationId")
    public List<OperatorAndRole> findOperatorAndRoleByOperatorIdAndOrganizationId(@RequestParam Long operatorId, @RequestParam Long organizationId) {
        return this.operatorAndRoleService.findOperatorAndRoleByOperatorIdAndOrganizationId(operatorId, organizationId);
    }
